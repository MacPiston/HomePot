...
public:
    void exportToTxt(dbManager database, QString tablename, QString filename) override;
    void exportToExcel(dbManager database, QString tablename, QString filename) override;
};
